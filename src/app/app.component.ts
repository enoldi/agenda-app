...
export class AppComponent {
  ...
  events: Array<any> = [
    ...
    {time: '12:00', subject: 'Lunch with Timmoty', location: 'Canteen', description: `Project evalutation ile ` +
    `declaring a variable and using an if statement is a fine way to conditionally render a component, sometimes you might want to use a`},
  ];
